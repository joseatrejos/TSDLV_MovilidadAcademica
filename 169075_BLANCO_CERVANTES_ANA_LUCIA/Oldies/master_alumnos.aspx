<%@ Page Language="C#" AutoEventWireup="true" CodeFile="master_alumnos.aspx.cs" Inherits="master_alumnos" %>
...
<head runat="server">
    ...
    <title>Master Alumnos | Intercambio</title>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <a href="#" class="btn btn-add" data-toggle="modal" data-target="#crearAlumno">
                ...
                <form id="frm_master_alumnos" runat="server">
