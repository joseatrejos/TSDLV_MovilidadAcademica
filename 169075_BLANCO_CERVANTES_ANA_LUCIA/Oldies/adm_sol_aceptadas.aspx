<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adm_sol_aceptadas.aspx.cs" Inherits="adm_sol_aceptadas" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Administrador Solicitudes Aceptadas | Intercambio</title>
...
float: right;
font-size: 16px;">
      <a id="buttonSignOut" href="adm_indexAdmin.aspx">
  ...
  <div id="page-wrapper" >
    <div id="page-inner">
      <div class="row">
        <div class="col-md-12">
          <h2 class="bg-color-aceptadas">Solicitudes Aceptadas</h2>
      </div>
    </div>
      <!-- /. ROW  -->
      <hr />
                  ...
                  <div class="panel panel-default">
                    <div class="panel-body">
                      ...
                      <div class="modal-footer">
                        ...
                        <asp:Button runat="server" ID="adm_sol_aceptadas_modal_boton_aceptar" Text="Si, aceptar" CssClass="btn btn-success" OnClick="adm_sol_aceptadas_modal_boton_aceptar_Click"/>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-body">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                        <asp:Button runat="server" ID="adm_sol_aceptadas_modal_rechazar" Text="Si, rechazar" CssClass="btn btn-danger" OnClick="adm_sol_aceptadas_modal_rechazar_Click"/>
                    </div>
                  </div>
                </div>
              </div>
