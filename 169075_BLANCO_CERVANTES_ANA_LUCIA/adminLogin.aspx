<%@ Page Title="Login Administrador" Language="C#" AutoEventWireup="true" CodeFile="adminLogin.aspx.cs" Inherits="adminLogin" %>
...
================================================== -->
<body>
    <form id="frm_Main_Alumno" runat="server">
        ...
        <br><br><br><br>
        <h1 class="center">Bienvenido, para continuar, conéctese con su usuario</h1> 
        <hr/>
            ...
            <div class="row contacto">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label1" runat="server" Text="Usuario: "></asp:Label><asp:TextBox ID="txtusuario" runat="server" CssClass="form-control"></asp:TextBox><br /><asp:RequiredFieldValidator ControlToValidate="txtusuario" ID="RequiredFieldValidator1" runat="server" ErrorMessage="El usuario es requerido" Display="Dynamic" Text="*" ValidationGroup="AllValidators" CssClass="validar"></asp:RequiredFieldValidator>
                    </div>
                    <!-- Contraseña -->
                    <div class="form-group">
